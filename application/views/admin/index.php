...
<body>
  <marquee style="color:white"><h3>Selamat Datang Di Perpustakan<h3></marquee>
  </body>
  </html>
</body>
</html>
...
<div class="page-header">
  <body background="img/background-web.png" style="background-size: cover">
    <h2 style="color: white"><img src="img/das5.png" width="100" height="50"> </li>DASBOARD</h2> 
  </div>
  <div class="row">
        ...
        <div class="panel-heading">
          <div class="row">
            ...
            <div class="col-xs-9 text-right">
              ...
              <h3 class="panel-title" style="fonts-ize:18px;font-weight:bold;"></i>jumlah buku yang terdaftar</h3>
            </div>
          </div>
        </div>
  ...
  <div class="row">
    <div class="col-lg-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body" style="background-color: fuchsia">
          ...
          <div class="text-right">
            <a href="<?php echo base_url().'admin/buku' ?>" style="color:black">Lihat Semua Buku <i class="glyphicon glyphicon-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-3">
      <div class="panel panel-primary">
        ...
        <div class="panel-body" style="background-color: yellow">
          ...
          <div class="text-right">
            <a href="<?php echo base_url().'admin/anggota' ?>" style="color:black;"> Lihat Semua Anggota <i class="glyphicon glyphicon-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-5">
      <div class="panel panel-default">
       <marquee direction="down" scrollamount="2" align="center"><h3 class="panel-title" style="font-size:18px;font-weight:bold;"><i class="glyphicon glyphicon-sort"></i> Peminjaman Terakhir</h3></marquee>
     </div>
     <div class="panel-body">
      <div class="table-responsive">
        <table class="tabel table-bordered tablehover table-striped" style="background-color: teal">
          <thead>
            <tr>
              <th>Tgl. Transaksi</th>
              <th>Tgl. Pinjam</th>
      ...
      <div class="text-right">
        <a href="<?php echo base_url().'admin/transaksi' ?>" style="color:white;">Lihat Semua Transaksi <i class="glyphicon glyphicon-arrow-right" style="color:white;" style="margin-top:50px"></i></a>
      </div>
    </div>
  </div>
